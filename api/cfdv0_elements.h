...
// Flux: positive and negative values
template < typename PRECISION >
struct flux{
	PRECISION pos, neg;
};

// binary system: a cell and its neighbor of interest
template < typename PRECISION >
struct binary_system{
	PRECISION cell, neigh;
};
...
struct t_solution_vars{
	...
	PRECISION q_new[DIM_CNT+2];			// Solution vector at t_{n+1}
