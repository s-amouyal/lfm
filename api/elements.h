...
enum initial_condition {
	ISENTROPIC_VORTEX			= 0,			// Isentropic Vortex (Euler)
	DOUBLE_SHEAR_LAYER_1		= 1,			// Double Shear Layer (Euler and NS)
	DOUBLE_SHEAR_LAYER_2		= 2,			// Double Shear Layer (Euler and NS)
	TAYLOR_GREEN_VORTEX			= 3,			// Taylor-Green Vortex (NS)
	CYLINDER_TUNNEL				= 4,			// Cylinder in tunnel (NS)
};
	...
	public:
		...
		void resize( int n_elements ){
			...
			if( array_is_allocated ){
				...
				cout << "allocated =" << setw(10) << array_is_allocated << endl;
